/* This is just a helper file to load the demo dataset into mongoDB */
...
const phoneJson = require('./demo/phonelisting_demo.json');
const userJson = require('./demo/userlist_demo.json');
